...
<template>
    <div class="flex justify-between mt-10 pt-6 border-t border-muted/50">
        ...
        <button
            ...
            class="inline-flex items-center justify-center px-6 py-2 text-sm font-medium bg-primary text-primary-foreground rounded-md hover:brightness-110 disabled:opacity-50 disabled:cursor-not-allowed transition-all active:scale-95 min-w-[120px]"
        >
